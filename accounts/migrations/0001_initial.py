    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('teacher', 'Teacher'), ('student', 'Student'), ('parent', 'Parent')], default='admin', max_length=20, verbose_name='user type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('school_year', models.CharField(max_length=50, verbose_name='school year')),
                ('birth_date', models.DateField(verbose_name='birth date')),
                ('address', models.TextField(help_text='Street, number, postal code and location', verbose_name='address')),
