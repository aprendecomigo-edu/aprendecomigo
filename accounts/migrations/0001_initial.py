...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('school_owner', 'School Owner'), ('school_admin', 'School Administrator'), ('teacher', 'Teacher'), ('student', 'Student'), ('parent', 'Parent')], max_length=20, verbose_name='role')),
                ('is_active', models.BooleanField(default=True, verbose_name='is active')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_minimum_notice_minutes', models.PositiveIntegerField(default=120, help_text='Default minimum notice period in minutes (2 hours)', verbose_name='default minimum notice minutes')),
                ('default_buffer_time_minutes', models.PositiveIntegerField(default=15, help_text='Default buffer time between classes in minutes', verbose_name='default buffer time minutes')),
                ('default_max_daily_bookings', models.PositiveIntegerField(default=8, help_text='Default maximum classes per day for teachers', verbose_name='default max daily bookings')),
                ('default_max_weekly_bookings', models.PositiveIntegerField(default=30, help_text='Default maximum classes per week for teachers', verbose_name='default max weekly bookings')),
                ('student_max_daily_bookings', models.PositiveIntegerField(default=3, help_text='Maximum classes per day for students', verbose_name='student max daily bookings')),
                ('student_max_weekly_bookings', models.PositiveIntegerField(default=10, help_text='Maximum classes per week for students', verbose_name='student max weekly bookings')),
                ('buffer_time_group', models.PositiveIntegerField(default=20, help_text='Buffer time in minutes for group classes', verbose_name='buffer time for group classes')),
                ('buffer_time_trial', models.PositiveIntegerField(default=10, help_text='Buffer time in minutes for trial classes', verbose_name='buffer time for trial classes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('minimum_notice_minutes', models.PositiveIntegerField(blank=True, help_text='Override minimum notice period in minutes (school default if null)', null=True, verbose_name='minimum notice minutes')),
                ('buffer_time_minutes', models.PositiveIntegerField(blank=True, help_text='Buffer time between classes in minutes (school default if null)', null=True, verbose_name='buffer time minutes')),
                ('max_daily_bookings', models.PositiveIntegerField(blank=True, help_text='Maximum classes per day (school default if null)', null=True, verbose_name='maximum daily bookings')),
                ('max_weekly_bookings', models.PositiveIntegerField(blank=True, help_text='Maximum classes per week (school default if null)', null=True, verbose_name='maximum weekly bookings')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="Name of the educational system (e.g., 'Portugal')", max_length=100, verbose_name='system name')),
                ('code', models.CharField(choices=[('pt', 'Portugal'), ('custom', 'Custom')], help_text="Unique code for the system (e.g., 'pt')", max_length=20, unique=True, verbose_name='system code')),
            ...
            options={
                ...
                'ordering': ['name', 'code'],
                'indexes': [models.Index(fields=['code'], name='accounts_ed_code_23b18c_idx'), models.Index(fields=['name'], name='accounts_ed_name_a84045_idx'), models.Index(fields=['is_active'], name='accounts_ed_is_acti_095f4f_idx'), models.Index(fields=['created_at'], name='accounts_ed_created_8099c4_idx')],
            },
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('educational_system', models.ForeignKey(help_text='Educational system this course belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='accounts.educationalsystem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('child', models.ForeignKey(help_text='Child user whose account is managed by the parent', on_delete=django.db.models.deletion.CASCADE, related_name='parent_relationships', to=settings.AUTH_USER_MODEL, verbose_name='child')),
                ('parent', models.ForeignKey(help_text='Parent user who manages the child account', on_delete=django.db.models.deletion.CASCADE, related_name='children_relationships', to=settings.AUTH_USER_MODEL, verbose_name='parent')),
                ('school', models.ForeignKey(help_text='School where this relationship is established', on_delete=django.db.models.deletion.CASCADE, to='accounts.school', verbose_name='school')),
            ],
            options={
