...
class StudentPermission(models.Model):
    ...
    student = models.ForeignKey("StudentProfile", on_delete=models.CASCADE, related_name="permissions")
    user = models.ForeignKey("CustomUser", on_delete=models.CASCADE, related_name="student_permissions")
