...
class TeacherInvitationModelTest(TestCase):
    ...
    def setUp(self):
        """Set up test data."""
        self.school = School.objects.create(name="Test School", description="School for testing invitations")

        self.school_owner = CustomUser.objects.create_user(
            email="owner@testschool.com", name="School Owner", phone_number="+351912000001"
        )

        SchoolMembership.objects.create(
            user=self.school_owner, school=self.school, role=SchoolRole.SCHOOL_OWNER, is_active=True
        )
    ...
    def test_teacher_invitation_token_uniqueness_ensures_security(self):
        ...
        invitation1 = TeacherInvitation.objects.create(
            school=self.school, email="teacher1@example.com", invited_by=self.school_owner, batch_id=self.batch_id
        )

        invitation2 = TeacherInvitation.objects.create(
            school=self.school, email="teacher2@example.com", invited_by=self.school_owner, batch_id=self.batch_id
        )
    ...
    def test_teacher_invitation_default_values(self):
        ...
        invitation = TeacherInvitation.objects.create(
            school=self.school, email="teacher@example.com", invited_by=self.school_owner, batch_id=self.batch_id
        )
        ...
        self.assertAlmostEqual(invitation.expires_at, expected_expiry, delta=timedelta(seconds=1))

    def test_teacher_invitation_validation(self):
        """Test invitation field validation."""
        # Test valid email
        invitation = TeacherInvitation.objects.create(
            school=self.school, email="valid@example.com", invited_by=self.school_owner, batch_id=self.batch_id
        )
...
class TeacherInvitationManagerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.school_owner = CustomUser.objects.create_user(email="owner@testschool.com", name="School Owner")
    ...
    def test_active_invitations_queryset(self):
        ...
        active_invitation = TeacherInvitation.objects.create(
            school=self.school, email="active@example.com", invited_by=self.school_owner, batch_id=batch_id
        )
    ...
    def test_for_school_queryset(self):
        ...
        invitation1 = TeacherInvitation.objects.create(
            school=self.school, email="teacher1@example.com", invited_by=self.school_owner, batch_id=batch_id
        )

        invitation2 = TeacherInvitation.objects.create(
            school=school2, email="teacher2@example.com", invited_by=self.school_owner, batch_id=batch_id
        )
    ...
    def test_for_batch_queryset(self):
        ...
        invitation1 = TeacherInvitation.objects.create(
            school=self.school, email="teacher1@example.com", invited_by=self.school_owner, batch_id=batch_id1
        )

        invitation2 = TeacherInvitation.objects.create(
            school=self.school, email="teacher2@example.com", invited_by=self.school_owner, batch_id=batch_id2
        )
