...
class SchoolSettingsViewTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        # Create test school
        self.school = School.objects.create(name="Test School", description="A test school for settings testing")
        ...
        SchoolMembership.objects.create(
            user=self.school_admin, school=self.school, role=SchoolRole.SCHOOL_ADMIN, is_active=True
        )
