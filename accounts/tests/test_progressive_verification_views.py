...
class SignUpViewTestCase(BaseTestCase):
    ...
    def test_signup_post_successful_creates_unverified_session(self, mock_send_sms, mock_send_email):
        ...
        unverified_until = timezone.datetime.fromtimestamp(
            unverified_until_timestamp, tz=timezone.get_current_timezone()
        )
...
class VerificationEdgeCasesTestCase(BaseTestCase):
    ...
    def test_verification_required_after_field_nullable(self):
        ...
        legacy_user = User.objects.create_user(email="legacy@example.com", name="Legacy User")
