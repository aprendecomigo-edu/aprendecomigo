...
class ProgressiveVerificationMiddlewareTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        # Create test users
        self.unverified_user_in_grace = User.objects.create_user(
        ...
        self.unverified_user_expired = User.objects.create_user(
    ...
    def test_middleware_clears_session_for_expired_unverified_users(self):
        ...
        request = self._create_request(
            path='/dashboard/', 
            user=self.unverified_user_expired,
    ...
    def test_middleware_checks_session_expiry_during_grace_period(self):
        ...
        session_data = {
            'unverified_until': expired_timestamp,
            'is_unverified_user': True
        }
        request = self._create_request(
            path='/dashboard/',
            user=self.unverified_user_in_grace,
            session_data=session_data
        )
