...
class PaymentPlan(models.Model):
    ...
    hours_included = models.IntegerField(_("hours included"), default=0, help_text=_("For package plans"))
    expiration_period = models.IntegerField(_("expiration period"), default=0, help_text=_("Days until package expires"))
...
class StudentPayment(models.Model):
    ...
    period_start = models.DateField(_("period start"), null=True, blank=True, help_text=_("For monthly plans"))
    period_end = models.DateField(_("period end"), null=True, blank=True, help_text=_("For monthly plans"))
    hours_purchased = models.DecimalField(_("hours purchased"), max_digits=10, decimal_places=2, default=0, help_text=_("For package plans"))
    hours_used = models.DecimalField(_("hours used"), max_digits=10, decimal_places=2, default=0, help_text=_("For package plans"))
    ...
    def is_expired(self):
        ...
        elif self.payment_plan.plan_type == "package" and self.payment_plan.expiration_period > 0:
            expiration_date = self.payment_date + timedelta(days=self.payment_plan.expiration_period)
...
class TeacherCompensation(models.Model):
    ...
    hours_taught = models.DecimalField(_("hours taught"), max_digits=10, decimal_places=2)
