...
from scheduling.models import ClassType, ClassSession, Subject
...
class FinancialPermissionsTestCase(TestCase):
    ...
    def test_student_payment_detail_permissions(self):
        ...
        url = reverse('financials:student_payment_detail', args=[self.student_payment.id])
        other_url = reverse('financials:student_payment_detail', args=[self.other_student_payment.id])
    ...
    def test_teacher_compensation_detail_permissions(self):
        ...
        url = reverse('financials:teacher_compensation_detail', args=[self.teacher_compensation.id])
        other_url = reverse('financials:teacher_compensation_detail', args=[self.other_teacher_compensation.id])
    ...
    def test_teacher_compensations_permissions(self):
        ...
        other_url = reverse('financials:teacher_compensations', args=[self.other_teacher.id])
