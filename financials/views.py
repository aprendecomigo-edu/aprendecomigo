...
def admin_dashboard(request):
    ...
    return render(
        request,
        "financials/admin_dashboard.html",
        {
...
def payment_plan_list(request):
    ...
    return render(
        request,
        "financials/payment_plan_list.html",
        {
...
def payment_plan_detail(request, pk):
    ...
    return render(
        request,
        "financials/payment_plan_detail.html",
        {
...
def student_payment_list(request):
    ...
    if is_staff_or_admin(request.user):
        ...
        payments = StudentPayment.objects.filter(student=request.user).order_by(
            "-payment_date"
        )
    else:
    ...
    return render(
        request,
        "financials/student_payment_list.html",
        {
            "payments": payments,
        },
    )
...
def student_payment_detail(request, pk):
    ...
    return render(
        request,
        "financials/student_payment_detail.html",
        {
            "payment": payment,
...
def student_payments(request, student_id):
    ...
    return render(
        request,
        "financials/student_payments.html",
        {
            "student": student,
            "payments": payments,
...
def teacher_compensation_list(request):
    ...
    return render(
        request,
        "financials/teacher_compensation_list.html",
        {
...
def teacher_compensation_detail(request, pk):
    ...
    return render(
        request,
        "financials/teacher_compensation_detail.html",
        {
...
def teacher_compensations(request, teacher_id):
    ...
    compensations = TeacherCompensation.objects.filter(teacher=teacher).order_by(
        "-period_end"
    )
    ...
    return render(
        request,
        "financials/teacher_compensations.html",
        {
            "teacher": teacher,
            "compensations": compensations,
...
def payment_report(request):
    ...
    report = StudentPaymentService.generate_payment_report(
    ...
    return render(
        request,
        "financials/payment_report.html",
        {
            "report": report,
            "students": students,
...
def compensation_report(request):
    ...
    report = TeacherCompensationService.generate_compensation_report(
    ...
    return render(
        request,
        "financials/compensation_report.html",
        {
            "report": report,
            "teachers": teachers,
...
def financial_summary(request):
    ...
    return render(
        request,
        "financials/financial_summary.html",
        {
            "summary": summary,
            "start_date": start_date,
            "end_date": end_date,
