...
def update_student_payments_on_student_change(sender, instance, action, pk_set, **kwargs):
    """
...
def check_payment_plan_expiration(sender, instance, **kwargs):
    ...
    if StudentPaymentService.is_payment_expired(instance):
        ...
        if instance.payment_plan.plan_type == "package" and instance.remaining_hours <= 0:
