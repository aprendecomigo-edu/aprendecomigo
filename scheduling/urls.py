...
urlpatterns = [
    ...
    path('class-types/<int:class_type_id>/edit/', views.edit_class_type, name='edit_class_type'),
    path('class-types/<int:class_type_id>/delete/', views.delete_class_type, name='delete_class_type'),
    ...
    path('api/student/upcoming-classes/', views.upcoming_classes, name='upcoming_classes'),
