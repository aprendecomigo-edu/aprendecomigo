...
class GoogleCalendarServiceTests(TestCase):
    ...
    def test_get_credentials(self, mock_credentials, mock_social_token, mock_social_account):
...
class FetchCalendarEventsTests(TestCase):
    ...
    def test_fetch_calendar_events(self, mock_get_service):
        ...
        mock_service.events.return_value.list.return_value.execute.return_value = self.mock_events
...
class SyncCalendarEventsTests(TestCase):
    ...
    def test_sync_calendar_events(self, mock_fetch_events):
        ...
        # Call the function
        created, updated, total = sync_calendar_events(self.calendar_id, admin_email="admin@test.com")
        ...
        self.assertEqual(User.objects.count(), initial_user_count + 2)  # New teacher and student
