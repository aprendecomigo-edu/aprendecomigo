...
from .models import ClassSession, Subject, ClassType
...
def fetch_calendar_events(calendar_id, days=30, admin_email=None, start_date=None, end_date=None):
    """
...
def sync_calendar_events(calendar_id, days=30, admin_email=None, start_date=None, end_date=None):
    """
    ...
    for event_data in events:
        ...
        teacher_first_name = teacher_name.split()[0] if " " in teacher_name else teacher_name
        ...
        try:
            ...
            try:
                ...
                print(f"Created placeholder teacher: {teacher.email} (needs profile completion)")
        ...
        student_first_name = student_name.split()[0] if " " in student_name else student_name
        ...
        try:
            ...
            try:
                ...
                print(f"Created placeholder student: {student.email} (needs profile completion)")
