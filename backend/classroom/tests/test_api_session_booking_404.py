...
class SessionBookingViewSetEndpointTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.school = School.objects.create(
            name='Test School',
            description='Test school for session booking tests',
        ...
        # Create student account balance (replacement for StudentPackage)
        # Note: StudentPackage model doesn't exist, using StudentAccountBalance instead
