...
class MessagingTestBase(TestCase):
    ...
    def _create_school_and_users(self):
        ...
        self.school = School.objects.create(
            name="Test School",
            description="A test school for messaging tests",
    ...
    def create_purchase_transaction(self, student=None, transaction_type=TransactionType.PACKAGE, 
                                    amount=50.0, expires_at_days=7):
        """
    ...
    def create_teacher_invitation(self, email="teacher@test.com", role=SchoolRole.TEACHER,
                                 status=InvitationStatus.PENDING, expires_in_days=7,
                                 custom_message=None):
        """
