...
from messaging.models import (
    SchoolEmailTemplate, EmailSequence, EmailSequenceStep, 
    EmailCommunication, EmailTemplateType, EmailCommunicationType
)
...
class SchoolEmailTemplateAPITest(CommunicationAPITestCase):
    ...
    def test_delete_email_template(self):
        ...
        # Verify deletion
        self.assertFalse(
            SchoolEmailTemplate.objects.filter(pk=self.email_template.pk).exists()
        )
    ...
    def test_communication_settings_update(self):
        ...
        data = {
            ...
            'notification_preferences': {
                'email_delivery_notifications': False,
