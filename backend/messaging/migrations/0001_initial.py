    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(help_text='School this template belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='email_templates', to='accounts.school')),
            ],
            options={
