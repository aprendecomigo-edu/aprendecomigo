...
class EmailCommunicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'sequence', 'sequence_name', 'subject',
            'delivery_status', 'queued_at', 'sent_at', 'delivered_at',
            'opened_at', 'clicked_at', 'failed_at', 'failure_reason',
            'created_by', 'sent_by_name', 'retry_count', 'max_retries'
        ]
        read_only_fields = [
            'id', 'school_name', 'template_name', 'sequence_name',
            'sent_by_name', 'delivery_status', 'queued_at', 'sent_at', 'delivered_at',
            'opened_at', 'clicked_at', 'failed_at', 'failure_reason'
        ]
