...
class StandardErrorResponseSerializer(serializers.Serializer):
    ...
    class ErrorDetailSerializer(serializers.Serializer):
        ...
        details = serializers.JSONField(
            required=False,
            help_text="Additional context or validation errors"
        )
...
def create_invitation_not_found_response(
    request_path: Optional[str] = None
) -> Response:
...
def create_invitation_expired_response(
    request_path: Optional[str] = None,
...
def create_invitation_invalid_recipient_response(
    expected_email: str,
    request_path: Optional[str] = None
) -> Response:
...
def create_school_membership_exists_response(
    school_name: str,
    request_path: Optional[str] = None
) -> Response:
