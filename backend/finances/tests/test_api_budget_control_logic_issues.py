...
# ApprovalStatus constants (status field choices)
class ApprovalStatus:
    ...
    EXPIRED = 'expired'
    CANCELLED = 'cancelled'
    REQUIRES_REVIEW = 'requires_review'  # For edge cases
...
class FamilyBudgetControlApprovalLogicTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.school = School.objects.create(
            name='Test School',
            description='Test school for budget control tests',
            contact_email='admin@testschool.com'
        )
        
        # Create student profile
        from accounts.models import EducationalSystem
        educational_system = EducationalSystem.objects.first() or EducationalSystem.objects.create(
            name='Test System', country='PT'
        )
    ...
    def test_budget_control_multi_school_logic_fails(self):
        ...
        other_school = School.objects.create(
            name='Other School',
            description='Other school for multi-school tests',
...
class FamilyBudgetControlEdgeCaseTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.school = School.objects.create(
            name='Test School',
            description='Test school for edge case tests',
            contact_email='admin@testschool.com'
        )
