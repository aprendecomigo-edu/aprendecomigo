...
def mask_card_last4(card_last4: str | None) -> str | None:
    """
...
def unmask_card_last4_for_display(card_last4: str | None) -> str:
    """
...
def get_secure_card_display(card_brand: str | None, card_last4: str | None) -> str:
    """
