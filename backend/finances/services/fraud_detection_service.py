...
class FraudDetectionService:
    ...
    def get_active_alerts(
        ...
        try:
            alerts_query = FraudAlert.objects.filter(
                status=FraudAlertStatus.ACTIVE
            ).select_related('target_user', 'assigned_to').order_by('-created_at')
    ...
    def _check_multiple_payment_methods(self, transaction: PurchaseTransaction) -> Dict[str, Any]:
        ...
        payment_methods_count = StoredPaymentMethod.objects.filter(
            student=user,
    ...
    def _check_rapid_transactions(self, transaction: PurchaseTransaction) -> Dict[str, Any]:
        ...
        rapid_count = PurchaseTransaction.objects.filter(
            student=user,
    ...
    def _analyze_user_patterns(
        ...
        return {
            'risk_score': risk_score,
            'patterns': patterns,
            'alert_type': 'user_behavior_analysis'
        }
    ...
    def _format_alert_description(self, risk_data: Dict[str, Any]) -> str:
        ...
        descriptions = {
            ...
            'user_behavior_analysis': f"Suspicious user behavior pattern detected across multiple transactions"
        }
