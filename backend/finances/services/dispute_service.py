    ...
    def update_dispute_notes(
        ...
        try:
            ...
            return {
                'success': True,
                'dispute_id': dispute_id,
                'message': 'Dispute notes updated successfully'
            }
    ...
    def _submit_stripe_evidence(
        ...
        try:
            ...
            return {
                'success': True,
                'dispute': dispute,
                'message': 'Evidence submitted to Stripe successfully'
            }
