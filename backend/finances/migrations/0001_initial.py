    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_type', models.CharField(choices=[('individual', 'Individual Session'), ('group', 'Group Session')], max_length=20, verbose_name='session type')),
                ('grade_level', models.CharField(help_text="Grade level of the session (e.g., '7', '10', 'mixed')", max_length=10, verbose_name='grade level')),
                ('student_count', models.PositiveSmallIntegerField(default=1, help_text='Number of students in this session', verbose_name='student count')),
                ('is_trial', models.BooleanField(default=False, help_text='Whether this is a trial session', verbose_name='is trial')),
                ('is_makeup', models.BooleanField(default=False, help_text='Whether this is a makeup session', verbose_name='is makeup')),
                ...
                ('actual_duration_hours', models.DecimalField(blank=True, decimal_places=2, help_text='Actual duration in hours when session was completed', max_digits=4, null=True, verbose_name='actual duration hours')),
                ('booking_confirmed_at', models.DateTimeField(blank=True, help_text='Timestamp when the session booking was confirmed', null=True, verbose_name='booking confirmed at')),
                ('cancelled_at', models.DateTimeField(blank=True, help_text='Timestamp when the session was cancelled', null=True, verbose_name='cancelled at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('approval_request', models.ForeignKey(blank=True, help_text='Approval request that authorized this transaction (if applicable)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purchase_transactions', to='finances.purchaseapprovalrequest', verbose_name='approval request')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rule_type', models.CharField(choices=[('grade_specific', 'Grade Specific Rate'), ('group_class', 'Group Class Rate'), ('fixed_salary', 'Fixed Monthly Salary'), ('base_plus_bonus', 'Base Salary Plus Bonus')], max_length=20, verbose_name='rule type')),
                ('grade_level', models.CharField(blank=True, help_text="Grade level for grade-specific rules (e.g., '7', '10')", max_length=10, null=True, verbose_name='grade level')),
                ('rate_per_hour', models.DecimalField(blank=True, decimal_places=2, help_text='Hourly rate in euros', max_digits=6, null=True, verbose_name='rate per hour')),
                ('fixed_amount', models.DecimalField(blank=True, decimal_places=2, help_text='Fixed monthly amount in euros', max_digits=8, null=True, verbose_name='fixed amount')),
                ('conditions', models.JSONField(blank=True, default=dict, help_text='Additional conditions for this rule (JSON format)', verbose_name='conditions')),
                ('is_active', models.BooleanField(default=True, verbose_name='is active')),
                ('effective_from', models.DateField(default=django.utils.timezone.now, help_text='Date from which this rule is effective', verbose_name='effective from')),
                ('effective_until', models.DateField(blank=True, help_text='Date until which this rule is effective (optional)', null=True, verbose_name='effective until')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_compensation_rules', to='accounts.school', verbose_name='school')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compensation_rules', to='accounts.teacherprofile', verbose_name='teacher')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('billing_period', models.CharField(help_text="Billing period in YYYY-MM format (e.g., '2024-01')", max_length=7, verbose_name='billing period')),
                ('hours_taught', models.DecimalField(decimal_places=2, help_text='Number of hours taught in this session', max_digits=4, verbose_name='hours taught')),
                ('rate_applied', models.DecimalField(decimal_places=2, help_text='Hourly rate applied for this session', max_digits=6, verbose_name='rate applied')),
                ('amount_earned', models.DecimalField(decimal_places=2, help_text='Total amount earned for this session', max_digits=8, verbose_name='amount earned')),
                ('payment_status', models.CharField(choices=[('pending', 'Pending'), ('calculated', 'Calculated'), ('paid', 'Paid')], default='pending', max_length=20, verbose_name='payment status')),
                ('calculation_notes', models.TextField(blank=True, help_text='Notes about how the payment was calculated', verbose_name='calculation notes')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('compensation_rule', models.ForeignKey(blank=True, help_text='The compensation rule used for this calculation', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='payment_entries', to='finances.teachercompensationrule', verbose_name='compensation rule')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_payment_entries', to='accounts.school', verbose_name='school')),
                ('session', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='payment_entry', to='finances.classsession', verbose_name='session')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_entries', to='accounts.teacherprofile', verbose_name='teacher')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_customer_id', models.CharField(blank=True, help_text='Stripe Customer ID associated with this payment method', max_length=255, null=True, verbose_name='Stripe customer ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trial_cost_absorption', models.CharField(choices=[('school', 'School Absorbs Cost'), ('teacher', 'Teacher Absorbs Cost'), ('split', 'Split Cost 50/50')], default='school', help_text='Who absorbs the cost of trial classes', max_length=20, verbose_name='trial cost absorption')),
                ('teacher_payment_frequency', models.CharField(choices=[('weekly', 'Weekly'), ('biweekly', 'Bi-weekly'), ('monthly', 'Monthly')], default='monthly', help_text='How frequently teachers are paid', max_length=20, verbose_name='teacher payment frequency')),
                ('payment_day_of_month', models.PositiveSmallIntegerField(default=1, help_text='Day of the month when teachers are paid (1-28)', verbose_name='payment day of month')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('school', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='billing_settings', to='accounts.school', verbose_name='school')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['is_active', 'display_order'], name='finances_pr_is_acti_d5e588_idx'),
        ),
        migrations.AddIndex(
            model_name='pricingplan',
            index=models.Index(fields=['plan_type', 'is_active'], name='finances_pr_plan_ty_be4255_idx'),
        ),
        migrations.AddIndex(
            model_name='pricingplan',
            index=models.Index(fields=['is_featured', 'is_active'], name='finances_pr_is_feat_dab09e_idx'),
        ),
        migrations.AddField(
            model_name='paymentdispute',
            name='purchase_transaction',
            field=models.ForeignKey(help_text='The purchase transaction being disputed', on_delete=django.db.models.deletion.CASCADE, related_name='disputes', to='finances.purchasetransaction', verbose_name='purchase transaction'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='hourconsumption',
            name='purchase_transaction',
            field=models.ForeignKey(help_text='Original purchase transaction from which hours were consumed', on_delete=django.db.models.deletion.CASCADE, related_name='hour_consumptions', to='finances.purchasetransaction', verbose_name='purchase transaction'),
        ),
        migrations.AddField(
            model_name='hourconsumption',
            name='student_account',
            field=models.ForeignKey(help_text='Student account that this consumption is associated with', on_delete=django.db.models.deletion.CASCADE, related_name='hour_consumptions', to='finances.studentaccountbalance', verbose_name='student account'),
        ),
        migrations.AddField(
            model_name='fraudalert',
            name='assigned_to',
            field=models.ForeignKey(blank=True, help_text='Administrator assigned to investigate this alert', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_fraud_alerts', to=settings.AUTH_USER_MODEL, verbose_name='assigned to'),
        ),
        migrations.AddField(
            model_name='fraudalert',
            name='related_transactions',
            field=models.ManyToManyField(blank=True, help_text='Transactions that triggered this alert', related_name='fraud_alerts', to='finances.purchasetransaction', verbose_name='related transactions'),
        ),
        migrations.AddField(
            model_name='fraudalert',
            name='target_user',
            field=models.ForeignKey(blank=True, help_text='User associated with this fraud alert', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fraud_alerts', to=settings.AUTH_USER_MODEL, verbose_name='target user'),
        ),
        migrations.AddField(
            model_name='familybudgetcontrol',
            name='parent_child_relationship',
            field=models.OneToOneField(help_text='The parent-child relationship this budget control applies to', on_delete=django.db.models.deletion.CASCADE, related_name='budget_control', to='accounts.parentchildrelationship', verbose_name='parent-child relationship'),
        ),
        migrations.AddField(
            model_name='classsession',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_sessions', to='accounts.school', verbose_name='school'),
        ),
        migrations.AddField(
            model_name='classsession',
            name='students',
            field=models.ManyToManyField(blank=True, help_text='Students who attended this session', related_name='attended_sessions', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='classsession',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_sessions', to='accounts.teacherprofile', verbose_name='teacher'),
        ),
        migrations.AddField(
            model_name='adminaction',
            name='admin_user',
            field=models.ForeignKey(help_text='Administrator who performed this action', on_delete=django.db.models.deletion.PROTECT, related_name='admin_actions', to=settings.AUTH_USER_MODEL, verbose_name='admin user'),
        ),
        migrations.AddField(
            model_name='adminaction',
            name='target_dispute',
            field=models.ForeignKey(blank=True, help_text='Dispute affected by this action (if applicable)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin_actions', to='finances.paymentdispute', verbose_name='target dispute'),
        ),
        migrations.AddField(
            model_name='adminaction',
            name='target_transaction',
            field=models.ForeignKey(blank=True, help_text='Transaction affected by this action (if applicable)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin_actions', to='finances.purchasetransaction', verbose_name='target transaction'),
        ),
        migrations.AddField(
            model_name='adminaction',
            name='target_user',
            field=models.ForeignKey(blank=True, help_text='User affected by this action (if applicable)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin_actions_targeting_me', to=settings.AUTH_USER_MODEL, verbose_name='target user'),
        ),
        migrations.AddConstraint(
            model_name='teachercompensationrule',
            constraint=models.UniqueConstraint(condition=models.Q(('is_active', True)), fields=('teacher', 'school', 'rule_type', 'grade_level'), name='unique_active_teacher_rule'),
        ),
        migrations.AddIndex(
            model_name='storedpaymentmethod',
            index=models.Index(fields=['student', 'is_active'], name='finances_st_student_5a3cda_idx'),
        ),
        migrations.AddIndex(
            model_name='storedpaymentmethod',
            index=models.Index(fields=['stripe_payment_method_id'], name='finances_st_stripe__91a821_idx'),
        ),
        migrations.AddIndex(
            model_name='storedpaymentmethod',
        ...
        migrations.AddIndex(
            model_name='receipt',
            index=models.Index(fields=['student', 'generated_at'], name='finances_re_student_ad6876_idx'),
        ),
        migrations.AddIndex(
            model_name='receipt',
            index=models.Index(fields=['receipt_number'], name='finances_re_receipt_21cbaf_idx'),
        ),
        migrations.AddIndex(
            model_name='receipt',
            index=models.Index(fields=['transaction'], name='finances_re_transac_16f606_idx'),
        ),
        migrations.AddIndex(
            model_name='purchasetransaction',
            index=models.Index(fields=['student', 'payment_status'], name='finances_pu_student_7c93d8_idx'),
        ),
        migrations.AddIndex(
            model_name='purchasetransaction',
            index=models.Index(fields=['payment_status'], name='finances_pu_payment_4c82c2_idx'),
        ),
        migrations.AddIndex(
            model_name='purchasetransaction',
            index=models.Index(fields=['created_at'], name='finances_pu_created_2d08ff_idx'),
        ),
        migrations.AddIndex(
            model_name='purchasetransaction',
            index=models.Index(fields=['stripe_payment_intent_id'], name='finances_pu_stripe__34a676_idx'),
        ),
        migrations.AddIndex(
            model_name='purchasetransaction',
            index=models.Index(fields=['expires_at'], name='finances_pu_expires_d94582_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='hourconsumption',
            index=models.Index(fields=['student_account', 'consumed_at'], name='finances_ho_student_a9dee8_idx'),
        ),
        migrations.AddIndex(
            model_name='hourconsumption',
            index=models.Index(fields=['class_session'], name='finances_ho_class_s_5c7f2c_idx'),
        ),
        migrations.AddIndex(
            model_name='hourconsumption',
            index=models.Index(fields=['purchase_transaction'], name='finances_ho_purchas_1878ba_idx'),
        ),
        migrations.AddIndex(
            model_name='hourconsumption',
            index=models.Index(fields=['is_refunded'], name='finances_ho_is_refu_b228d2_idx'),
        ),
        migrations.AddConstraint(
            model_name='hourconsumption',
        ...
        migrations.AddIndex(
            model_name='fraudalert',
            index=models.Index(fields=['alert_id'], name='finances_fr_alert_i_2d2bf0_idx'),
        ),
        migrations.AddIndex(
            model_name='fraudalert',
            index=models.Index(fields=['severity', 'status', '-created_at'], name='finances_fr_severit_74a18d_idx'),
        ),
        migrations.AddIndex(
            model_name='fraudalert',
            index=models.Index(fields=['target_user', '-created_at'], name='finances_fr_target__7bd6e2_idx'),
        ),
        migrations.AddIndex(
            model_name='fraudalert',
            index=models.Index(fields=['assigned_to', 'status'], name='finances_fr_assigne_da9e13_idx'),
        ),
        migrations.AddIndex(
            model_name='fraudalert',
            index=models.Index(fields=['risk_score', '-created_at'], name='finances_fr_risk_sc_6bf5b5_idx'),
        ),
        migrations.AddIndex(
            model_name='fraudalert',
            index=models.Index(fields=['alert_type', 'status'], name='finances_fr_alert_t_c3d4a1_idx'),
        ),
        migrations.AddIndex(
            model_name='familybudgetcontrol',
            index=models.Index(fields=['parent_child_relationship', 'is_active'], name='finances_fa_parent__285adc_idx'),
        ),
        migrations.AddIndex(
            model_name='familybudgetcontrol',
            index=models.Index(fields=['auto_approval_threshold'], name='finances_fa_auto_ap_4abf96_idx'),
        ),
        migrations.AddIndex(
            model_name='adminaction',
