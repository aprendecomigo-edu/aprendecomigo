...
class TeacherAvailabilityTests(SchedulerAPITestCase):
    ...
    def test_teacher_can_create_availability(self):
        ...
        self.assertCreatedWithData(
            response, {"day_of_week": WeekDay.SATURDAY, "start_time": "09:00:00", "end_time": "12:00:00"}
        )
    ...
    def test_teacher_can_update_own_availability(self):
        ...
        availability = TeacherAvailability.objects.filter(
            teacher=self.teacher_profile, day_of_week=WeekDay.MONDAY
        ).first()
    ...
    def test_availability_permission_rules(self):
        ...
        other_availability = TeacherAvailability.objects.filter(teacher=self.teacher_profile2).first()
    ...
    def test_availability_validation_rules(self):
        ...
        for test_case in validation_tests:
            with self.subTest(description=test_case["description"]):
                response = self.client.post(self.availability_url, test_case["data"], format="json")
...
class TeacherUnavailabilityTests(SchedulerAPITestCase):
    ...
    def test_teacher_can_create_unavailability(self):
        ...
        self.assertCreatedWithData(response, {"date": self.tomorrow.isoformat(), "reason": "Doctor appointment"})
    ...
    def test_unavailability_creation_types(self):
        ...
        unavailability_types = [
            {
                ...
                "expected": {"reason": "Doctor appointment", "is_all_day": False},
            ...
            },
            {
                ...
                "expected": {"is_all_day": True, "reason": "Sick day"},
        ...
        for test_case in unavailability_types:
            with self.subTest(description=test_case["description"]):
                response = self.client.post(self.unavailability_url, test_case["data"], format="json")
    ...
    def test_teacher_unavailability_crud_operations(self):
        ...
        unavailability = self.create_teacher_unavailability(
            teacher=self.teacher_profile, date=self.tomorrow, reason="Test unavailability"
        )
    ...
    def test_unavailability_validation_and_permissions(self):
        ...
        other_unavailability = self.create_teacher_unavailability(teacher=self.teacher_profile2, date=self.tomorrow)
