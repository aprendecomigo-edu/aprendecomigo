...
from scheduler.models import (
    ClassSchedule, ClassStatus, ClassType, TeacherAvailability,
    TeacherUnavailability
)
from scheduler.serializers import (
    ClassScheduleSerializer, CreateClassScheduleSerializer,
    TeacherAvailabilitySerializer, TeacherUnavailabilitySerializer,
...
class TestClassScheduleSerializer(BaseAPITestCase):
    ...
    def test_serialization_includes_enhanced_fields(self):
        ...
        enhanced_fields = [
            'teacher_name', 'student_name', 'school_name',
            'class_type_display', 'status_display', 'participant_count',
    ...
    def test_read_only_fields_protection(self):
        ...
        critical_read_only = [
            ...
            'can_be_cancelled', 'is_past', 'participant_count'
        ]
    ...
    def test_cancel_serializer_flexibility(self):
        ...
        for data, description in test_cases:
            with self.subTest(case=description):
                serializer = CancelClassSerializer(data=data)
                self.assertTrue(serializer.is_valid(), 
                              f"Should be valid for {description}: {serializer.errors}")