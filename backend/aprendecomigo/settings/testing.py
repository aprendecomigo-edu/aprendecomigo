...
# Stripe Test Configuration - Use realistic test key formats that pass Stripe validation
STRIPE_SECRET_KEY = "sk_test_4eC39HqLyjWDarjtT1zdp7dc"  # Stripe's published test secret key
STRIPE_PUBLIC_KEY = "pk_test_TYooMQauvdEDq54NiTphI7jx"   # Stripe's published test public key
STRIPE_WEBHOOK_SECRET = "whsec_test_1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890"
