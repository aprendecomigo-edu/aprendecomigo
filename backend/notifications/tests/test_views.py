...
class NotificationUnreadCountAPITest(NotificationAPITestCase):
    ...
    def test_unread_count_updates_after_marking_read(self):
        ...
        # Mark one as read
        mark_read_url = reverse('notifications:notification-mark-read', kwargs={'pk': notification1.pk})
        ...
        mark_read_url = reverse('notifications:notification-mark-read', kwargs={'pk': notification2.pk})
        self.client.post(mark_read_url)
