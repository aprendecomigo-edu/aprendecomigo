...
from accounts.models import TeacherProfile, School, SchoolSettings
    ...
    WIZARD_STEPS = [
        {
            ...
            'fields': [
                'first_name', 'last_name', 'email', 'phone_number', 'profile_photo'
            ],
            'is_required': True,
        ...
        },
        {
            ...
            'fields': [
                'professional_bio', 'professional_title', 'years_experience',
                'education_background', 'teaching_experience', 'credentials_documents'
            ],
            'is_required': True,
        ...
        },
        {
            ...
            'fields': [
                'teaching_subjects', 'grade_level_preferences', 'specialty'
            ],
            'is_required': True,
        ...
        },
        {
            ...
            'fields': [
                'availability', 'weekly_availability', 'availability_schedule'
            ],
            'is_required': False,
    ...
    def _get_school_policies(cls, school: School) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'working_hours': {
                    'start': str(settings.working_hours_start),
                    'end': str(settings.working_hours_end)
                },
    ...
    def _generate_rate_constraints(cls, currency_code: str) -> Dict[str, Any]:
        ...
        currency_constraints = {
            'EUR': {
                'min_rate': 10.0,
                'max_rate': 100.0,
                'suggested_range': [15.0, 50.0],
                'currency_symbol': '€'
            },
            'USD': {
                'min_rate': 12.0,
                'max_rate': 120.0,
                'suggested_range': [18.0, 60.0],
                'currency_symbol': '$'
            },
            'BRL': {
                'min_rate': 50.0,
                'max_rate': 500.0,
                'suggested_range': [80.0, 250.0],
                'currency_symbol': 'R$'
            },
            'GBP': {
                'min_rate': 8.0,
                'max_rate': 80.0,
                'suggested_range': [12.0, 40.0],
                'currency_symbol': '£'
            }
        }
