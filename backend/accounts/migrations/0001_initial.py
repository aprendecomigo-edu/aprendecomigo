    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_integration_provider', models.CharField(blank=True, choices=[('gmail', 'Gmail'), ('outlook', 'Outlook'), ('custom', 'Custom SMTP')], help_text='Email integration provider', max_length=20, verbose_name='email integration provider')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_delivery_status', models.CharField(choices=[('not_sent', 'Not Sent'), ('queued', 'Queued'), ('sending', 'Sending'), ('sent', 'Sent'), ('delivered', 'Delivered'), ('opened', 'Opened'), ('clicked', 'Clicked'), ('failed', 'Failed'), ('bounced', 'Bounced'), ('spam', 'Marked as Spam')], default='not_sent', max_length=20, verbose_name='email delivery status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequence', models.ForeignKey(help_text='Email sequence this step belongs to', on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='accounts.emailsequence')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequence', models.ForeignKey(blank=True, help_text='Email sequence this belongs to (if automated)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sent_emails', to='accounts.emailsequence')),
                ('sequence_step', models.ForeignKey(blank=True, help_text='Sequence step this email represents', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sent_emails', to='accounts.emailsequencestep')),
