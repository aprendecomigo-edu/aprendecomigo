...
class IsParentWithChildrenPermissionTest(TestCase):
    """Test the IsParentWithChildren permission class."""
    ...
    def setUp(self):
        ...
        self.non_parent_user = User.objects.create(
            email="nonparent@test.com", 
            name="Non Parent User"
        )
    ...
    def test_parent_with_children_has_permission(self):
        """Test that users with active parent-child relationships have permission."""
        from accounts.permissions import IsParentWithChildren
        from rest_framework.test import APIRequestFactory
        from django.contrib.auth.models import AnonymousUser
        
        permission = IsParentWithChildren()
        ...
        request.user = self.non_parent_user
