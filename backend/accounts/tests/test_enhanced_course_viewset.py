...
class EnhancedCourseViewSetTestCase(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.edu_system_pt, _ = EducationalSystem.objects.get_or_create(
            code="pt", defaults={"name": "Portugal", "description": "Portuguese educational system"}
        )

        self.edu_system_custom, _ = EducationalSystem.objects.get_or_create(
            code="custom", defaults={"name": "Custom", "description": "Custom educational system"}
        )

        # Create schools
        self.school1 = School.objects.create(name="Test School 1", description="A test school")

        self.school2 = School.objects.create(name="Test School 2", description="Another test school")
        ...
        self.teacher1_user = User.objects.create_user(
            email="teacher1@example.com", name="John Teacher", password="testpass123"
        )
        ...
        self.teacher2_user = User.objects.create_user(
            email="teacher2@example.com", name="Jane Teacher", password="testpass123"
        )

        self.teacher2_profile = TeacherProfile.objects.create(
            user=self.teacher2_user, bio="Physics expert", specialty="Physics", hourly_rate=Decimal("30.00")
        )

        # Create school memberships
        SchoolMembership.objects.create(
            user=self.teacher1_user, school=self.school1, role=SchoolRole.TEACHER, is_active=True
        )
        ...
        TeacherCourse.objects.create(
            teacher=self.teacher1_profile, course=self.course_math, hourly_rate=Decimal("30.00")
        )

        TeacherCourse.objects.create(
            teacher=self.teacher1_profile, course=self.course_physics, hourly_rate=Decimal("25.00")
        )

        TeacherCourse.objects.create(
            teacher=self.teacher2_profile, course=self.course_physics, hourly_rate=Decimal("35.00")
        )

        # Create students for testing
        self.student1 = User.objects.create_user(email="student1@example.com", name="Student One")

        self.student2 = User.objects.create_user(email="student2@example.com", name="Student Two")
    ...
    def test_courses_filtering_by_educational_system(self):
        ...
        response = self.client.get(self.courses_url, {"educational_system": self.edu_system_pt.id})
    ...
    def test_courses_filtering_by_education_level(self):
        ...
        response = self.client.get(self.courses_url, {"education_level": "ensino_secundario"})
    ...
    def test_courses_search_functionality(self):
        ...
        # Search for "math"
        response = self.client.get(self.courses_url, {"search": "math"})
    ...
    def test_courses_with_popularity_metrics(self):
        ...
        response = self.client.get(self.courses_url, {"include_popularity": "true"})
    ...
    def test_courses_with_teacher_info(self):
        ...
        response = self.client.get(self.courses_url, {"include_teachers": "true"})
    ...
    def test_courses_with_market_data(self):
        ...
        response = self.client.get(self.courses_url, {"include_market_data": "true"})
    ...
    def test_courses_ordering_by_popularity(self):
        ...
        response = self.client.get(self.courses_url, {"include_popularity": "true", "ordering": "-popularity_score"})
        ...
        self.assertGreater(
            physics_course["popularity_metrics"]["popularity_score"],
    ...
    def test_courses_ordering_by_price(self):
        ...
        response = self.client.get(self.courses_url, {"include_market_data": "true", "ordering": "avg_hourly_rate"})
    ...
    def test_courses_caching(self):
        ...
        with (
            ...
            response = self.client.get(self.courses_url, {"include_popularity": "true", "include_market_data": "true"})
    ...
    def test_courses_invalid_filter_parameters(self):
        ...
        response = self.client.get(self.courses_url, {"educational_system": 999999})
    ...
    def test_courses_performance_with_large_dataset(self):
        ...
        for i in range(20):
            ...
            TeacherCourse.objects.create(
                teacher=self.teacher1_profile, course=course, hourly_rate=Decimal(f"{20 + i}.00")
            )
        ...
        response = self.client.get(
            self.courses_url, {"include_popularity": "true", "include_teachers": "true", "include_market_data": "true"}
        )
    ...
    def test_courses_empty_results(self):
        ...
        response = self.client.get(self.courses_url, {"search": "nonexistent"})
