...
from ..models import School, SchoolEmailTemplate, EmailTemplateType, SchoolRole
from ..services.secure_template_engine import (
...
class EmailTemplateModelSecurityTest(TestCase):
    ...
    def setUp(self):
        ...
        from ..models import SchoolMembership, SchoolRole
