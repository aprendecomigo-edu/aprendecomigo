...
class TeacherOnboardingBaseTest(TestCase):
    ...
    def setUp(self):
        ...
        self.existing_user = CustomUser.objects.create_user(
            ...
            name="Existing User",
            phone_number="+351 912 000 003"
        )
        
        self.regular_user = CustomUser.objects.create_user(
            email="regular@example.com",
            name="Regular User",
            phone_number="+351 912 000 004"
        )
        
        self.teacher_user = CustomUser.objects.create_user(
            email="teacher@example.com",
            name="Teacher User",
            phone_number="+351 912 000 005"
        )
...
class InviteNewTeacherTest(TeacherOnboardingBaseTest):
    ...
    def test_invite_without_permission(self):
        ...
        self.assertTrue(
            "don't have permission" in error_message or 
            "must be a school owner or administrator" in error_message,
...
class TeacherListFilteringTest(TeacherOnboardingBaseTest):
    ...
    def setUp(self):
        ...
        self.teacher2_user = CustomUser.objects.create_user(
            ...
            name="Teacher Two",
            phone_number="+351 912 000 006"
        )
        
        self.teacher3_user = CustomUser.objects.create_user(
            email="teacher3@example.com", 
            name="Teacher Three",
            phone_number="+351 912 000 007"
        )
...
class MultiSchoolScenarioTest(TeacherOnboardingBaseTest):
    ...
    def test_school_with_multiple_roles(self):
        ...
        staff_user = CustomUser.objects.create_user(
            ...
            name="Staff User",
            phone_number="+351 912 000 009"
        )
        
        SchoolMembership.objects.create(
            user=staff_user,
            school=self.school1,
            role=SchoolRole.SCHOOL_STAFF,
            is_active=True
        )
    ...
    def test_school_owner_can_self_onboard_as_teacher(self):
        ...
        # Check user can manually add teacher membership to their school
        SchoolMembership.objects.create(
            user=self.school_owner,
            school=self.school1,
            role=SchoolRole.TEACHER,
