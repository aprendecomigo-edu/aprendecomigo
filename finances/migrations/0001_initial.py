    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_sessions', to='accounts.school', verbose_name='school')),
                ('students', models.ManyToManyField(blank=True, help_text='Students who attended this session', related_name='attended_sessions', to=settings.AUTH_USER_MODEL)),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_sessions', to='accounts.teacherprofile', verbose_name='teacher')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['is_active', 'display_order'], name='finances_pr_is_acti_d5e588_idx'), models.Index(fields=['plan_type', 'is_active'], name='finances_pr_plan_ty_be4255_idx'), models.Index(fields=['is_featured', 'is_active'], name='finances_pr_is_feat_dab09e_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('receipt_number', models.CharField(blank=True, help_text='Unique receipt identifier', max_length=50, null=True, unique=True, verbose_name='receipt number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('class_session', models.ForeignKey(help_text='The class session for which hours were consumed', on_delete=django.db.models.deletion.CASCADE, related_name='hour_consumptions', to='finances.classsession', verbose_name='class session')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_from', models.DateField(default=datetime.date.today, help_text='Date from which this rule is effective', verbose_name='effective from')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['parent_child_relationship', 'is_active'], name='finances_fa_parent__285adc_idx'), models.Index(fields=['auto_approval_threshold'], name='finances_fa_auto_ap_4abf96_idx'), models.Index(fields=['created_at'], name='finances_fa_created_fc3e6b_idx'), models.Index(fields=['is_active', '-created_at'], name='finances_fa_is_acti_8b7ad3_idx')],
            },
        ),
        migrations.AddIndex(
