...
export type IButtonProps = Omit<React.ComponentPropsWithoutRef<any>, 'context'> &
  VariantProps<typeof buttonStyle> & { className?: string };

export type IButtonTextProps = React.ComponentPropsWithoutRef<any> &
  VariantProps<typeof buttonTextStyle> & { className?: string };

export type IButtonIcon = React.ComponentPropsWithoutRef<any> &
  VariantProps<typeof buttonIconStyle> & {
    className?: string | undefined;
    as?: React.ElementType;
  };

export type IButtonGroupProps = React.ComponentPropsWithoutRef<any> &
  VariantProps<typeof buttonGroupStyle>;

// Common function to create Button components
export function createButtonComponents(UIButton: any) {
  ...
  return { Button, ButtonText, ButtonSpinner, ButtonIcon, ButtonGroup };
}
