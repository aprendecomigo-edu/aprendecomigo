  ...
  return (
    <View className="flex-1 p-6">
      ...
      <Text className="text-gray-600 mb-6">
        Compare v1 (factory-based) and v2 (direct implementation) FormControl components.
        They should look and behave identically.
      </Text>

      <Pressable 
        onPress={validateForm}
        className="bg-blue-500 p-2 rounded mb-6"
      >
      ...
      <View className="mb-8">
        ...
        <FormControlV1 size="md">
          ...
          {showError && password.length < 6 && (
            <FormControlErrorV1>
              <FormControlErrorIconV1 as={ErrorIcon} />
              <FormControlErrorTextV1>Password must be at least 6 characters</FormControlErrorTextV1>
            </FormControlErrorV1>
          )}
      ...
      <View className="mb-8">
        ...
        <FormControlV2 size="md">
          ...
          {showError && password.length < 6 && (
            <FormControlErrorV2>
              <FormControlErrorIconV2 as={ErrorIcon} />
              <FormControlErrorTextV2>Password must be at least 6 characters</FormControlErrorTextV2>
            </FormControlErrorV2>
          )}
      ...
      <View className="mb-8">
        ...
        <FormControlV2Simple size="md" className="mb-4">
          ...
          {showError && !email.includes('@') && (
            <FormControlErrorV2Simple>
              ...
              <FormControlErrorTextV2Simple>Please enter a valid email</FormControlErrorTextV2Simple>
            </FormControlErrorV2Simple>
          )}
          
          <FormControlHelperV2Simple>
            <FormControlHelperTextV2Simple>We'll never share your email</FormControlHelperTextV2Simple>
          </FormControlHelperV2Simple>
        </FormControlV2Simple>
        ...
        <FormControlV2Simple size="md">
          ...
          {showError && password.length < 6 && (
            <FormControlErrorV2Simple>
              <FormControlErrorIconV2Simple as={ErrorIcon} />
              <FormControlErrorTextV2Simple>Password must be at least 6 characters</FormControlErrorTextV2Simple>
            </FormControlErrorV2Simple>
          )}
          
          <FormControlHelperV2Simple>
            <FormControlHelperTextV2Simple>Minimum 6 characters required</FormControlHelperTextV2Simple>
          </FormControlHelperV2Simple>
        </FormControlV2Simple>
      </View>
      ...
      <View className="p-4 bg-gray-100 rounded-md">
        <Text className="text-sm">
          ...
          • All three forms should look identical{'\n'}
          • Labels, helper text, and error states should work the same{'\n'}
          • Size variants should be consistent{'\n'}
          • Error icons should display properly{'\n'}
          • v2 Simple should have the same functionality with cleaner code
        </Text>
      </View>
    </View>
  );
