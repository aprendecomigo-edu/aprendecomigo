            ...
            <Box className="bg-blue-50 border border-blue-200 p-4 rounded-lg">
              <VStack space="sm">
                <Text className="text-blue-900 font-medium">
                  Quick Setup for Individual Tutors
                </Text>
                <Text className="text-blue-700 text-sm leading-relaxed">
                  We'll create a simple practice profile for you. You can always customize 
                  these details later in your settings. This helps organize your tutoring 
                  business and makes it easier for students to find you.
                </Text>
              </VStack>
            </Box>
