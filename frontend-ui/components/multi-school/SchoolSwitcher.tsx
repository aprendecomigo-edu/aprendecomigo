...
import { ResponsiveContainer, TouchFriendly, isMobile, getResponsiveTextSize } from '@/components/ui/responsive';
        ...
        <HStack space="sm" className="items-center">
          ...
          <VStack className="flex-1">
            ...
            <Text className="text-xs text-gray-500">
              {getRoleLabel(currentSchool.role)}
            </Text>
          </VStack>
                ...
                <>
                  ...
                  <VStack space="sm">
                    ...
                    {pendingInvitations.map((invitation) => (
                      <Box key={invitation.id} className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                        <HStack space="sm" className="items-center">
                          <Avatar size="sm">
                          ...
                          <VStack className="flex-1">
                            ...
                            <Text className="text-xs text-gray-600">
                              {getRoleLabel(invitation.role)} • Convidado por {invitation.invited_by.name}
                            </Text>
                            <Text className="text-xs text-gray-500">
