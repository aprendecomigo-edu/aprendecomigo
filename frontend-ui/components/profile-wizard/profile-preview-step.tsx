            ...
            <VStack space="xs" className="items-end">
              <HStack space="xs" className="items-center">
                <Text className="text-2xl font-bold text-white">
                  {currency}{formData.rate_structure?.individual_rate || 0}
                </Text>
              ...
              {formData.rate_structure?.trial_lesson_rate && (
                <Badge className="bg-yellow-400">
                  <BadgeText className="text-yellow-900 text-xs">
                    Trial: {currency}{formData.rate_structure.trial_lesson_rate}
                  </BadgeText>
                </Badge>
              )}
            </VStack>
        ...
        <VStack space="lg">
          ...
          <VStack space="sm">
            ...
            <Text className="text-gray-600">
              See how your profile appears to students. You can make changes by editing individual sections.
            </Text>
          </VStack>
          ...
          <Card className={`border-l-4 ${
            ...
            <VStack space="md" className="p-6">
              <HStack className="items-center justify-between">
                ...
                >
                  <ButtonText>
                    {showCompletionDetails ? 'Hide' : 'Show'} Details
                  </ButtonText>
                </Button>
              </HStack>
              
              <Progress value={getCompletionScore()} className="h-3">
                <ProgressFilledTrack className={
                  getCompletionScore() >= 90 
                    ? 'bg-green-600' 
                    : getCompletionScore() >= 70
                    ? 'bg-yellow-600'
            ...
            <VStack space="md" className="p-6">
              <HStack className="items-center justify-between">
                ...
                <HStack space="sm">
                  ...
                  >
                    <ButtonIcon as={Monitor} className={
                      previewMode === 'desktop' ? 'text-white mr-2' : 'text-gray-600 mr-2'
                    } />
                    <ButtonText className={
                      previewMode === 'desktop' ? 'text-white' : 'text-gray-600'
                    }>
                      Desktop
                    </ButtonText>
                  </Button>
                  ...
                  >
                    <ButtonIcon as={Smartphone} className={
                      previewMode === 'mobile' ? 'text-white mr-2' : 'text-gray-600 mr-2'
                    } />
                    <ButtonText className={
                      previewMode === 'mobile' ? 'text-white' : 'text-gray-600'
                    }>
                      Mobile
                    </ButtonText>
                  </Button>
              ...
              <VStack space="md" className="p-6">
                <HStack className="items-center justify-between">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onPress={() => handleEditSection('subjects')}
                  >
                    <ButtonIcon as={Edit} className="text-gray-600 mr-1" />
                    <ButtonText>Edit</ButtonText>
                  </Button>
              ...
              <VStack space="md" className="p-6">
                <HStack className="items-center justify-between">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onPress={() => handleEditSection('rates')}
                  >
                    <ButtonIcon as={Edit} className="text-gray-600 mr-1" />
                    <ButtonText>Edit</ButtonText>
                  </Button>
                ...
                <VStack space="sm">
                  <HStack className="items-center justify-between">
                    ...
                    <Text className="font-semibold text-gray-900">
                      {currency}{formData.rate_structure?.individual_rate || 0}/hour
                    </Text>
                  </HStack>
                  ...
                  {formData.rate_structure?.trial_lesson_rate && (
                    <HStack className="items-center justify-between">
                      ...
                      <Text className="font-semibold text-gray-900">
                        {currency}{formData.rate_structure.trial_lesson_rate}/hour
                      </Text>
                    </HStack>
                  )}
                  ...
                  {formData.rate_structure?.group_rate && (
                    <HStack className="items-center justify-between">
                      ...
                      <Text className="font-semibold text-gray-900">
                        {currency}{formData.rate_structure.group_rate}/student/hour
                      </Text>
                    </HStack>
                  )}
                </VStack>
                ...
                {formData.rate_structure?.package_deals?.length > 0 && (
                  <VStack space="sm" className="mt-4">
                    ...
                    {formData.rate_structure.package_deals.map((packageDeal: any, index: number) => (
                      <HStack key={index} className="items-center justify-between bg-gray-50 p-3 rounded-lg">
                        <VStack space="xs">
              ...
              <Card className="bg-gray-50 border-l-4 border-l-blue-500">
                <VStack space="sm" className="p-4">
                  ...
                  <Text className="text-green-700 text-sm">
                    aprende-comigo.com/tutor/{formData.first_name?.toLowerCase()}-{formData.last_name?.toLowerCase()}
                  </Text>
                  <Text className="text-gray-700 text-sm">
                    {formData.introduction || formData.professional_bio?.substring(0, 160) || 'Professional tutor offering personalized learning experiences...'}
                  </Text>
                  <HStack space="sm" className="mt-2">
                    <Badge className="bg-blue-100">
                      <BadgeText className="text-blue-800">
                        {currency}{formData.rate_structure?.individual_rate}/hr
                      </BadgeText>
                    </Badge>
                    ...
                    <Badge className="bg-yellow-100">
                      <BadgeText className="text-yellow-800">
                        ⭐ 5.0 (New)
                      </BadgeText>
                    </Badge>
                  </HStack>
          ...
          <Card className="border-l-4 border-l-green-500 bg-green-50">
            <VStack space="md" className="p-6">
              ...
              <Text className="text-green-800">
                Your profile looks great! When you complete the wizard, your profile will be published 
                and students will be able to find and book sessions with you.
              </Text>
