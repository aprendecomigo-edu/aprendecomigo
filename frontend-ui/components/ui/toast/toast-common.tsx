...
// Common function to create UIToast with platform-specific Root
export function createUIToast(Root: React.ComponentType<any>) {
...
export type IToastProps = React.ComponentProps<any> & {
  className?: string;
} & VariantProps<typeof toastStyle>;

export type IToastTitleProps = React.ComponentProps<any> & {
  className?: string;
} & VariantProps<typeof toastTitleStyle>;

export type IToastDescriptionProps = React.ComponentProps<any> & {
  className?: string;
} & VariantProps<typeof toastDescriptionStyle>;

// Common function to create Toast components
export function createToastComponents(UIToast: any) {
  ...
  return { Toast, ToastTitle, ToastDescription };
}