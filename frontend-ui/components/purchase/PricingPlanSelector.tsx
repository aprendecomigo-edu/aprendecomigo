  ...
  if (loading) {
    return (
      <VStack space="lg" className={`items-center py-12 ${className}`}>
        <Spinner size="large" />
        <Text className="text-typography-600 text-center">Loading pricing plans...</Text>
      </VStack>
    );
  }
  ...
  if (error) {
    return (
      <VStack space="lg" className={`py-8 ${className}`}>
        ...
        <Button action="secondary" variant="outline" onPress={refetch} className="self-center">
  ...
  if (plans.length === 0) {
    return (
      <VStack space="lg" className={`items-center py-12 ${className}`}>
        ...
        <Button action="secondary" variant="outline" onPress={refetch}>
          <ButtonIcon as={RefreshCw} />
