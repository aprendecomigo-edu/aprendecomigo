...
import { TrendingUp, Clock, BookOpen, Target, Calendar, BarChart3, AlertTriangle, RefreshCw } from 'lucide-react-native';
        ...
        <VStack space="md" className="w-full">
          <HStack space="md" className="flex-wrap">
            <StatCard
              ...
              trend={selectedTimeRange === 'month' ? `${usageStats.sessions_this_month} this month` : undefined}
            ...
            <StatCard
              ...
              trend={selectedTimeRange === 'month' ? `${usageStats.hours_this_month.toFixed(1)}h this month` : undefined}
          ...
          <HStack space="md" className="flex-wrap">
            ...
            <StatCard
              ...
              trend={usageStats.streak_days > 7 ? "Great momentum!" : usageStats.streak_days > 0 ? "Keep it up!" : "Start a streak"}
              trendColor={usageStats.streak_days > 7 ? "text-success-600" : usageStats.streak_days > 0 ? "text-warning-600" : "text-typography-600"}
              bgColor={usageStats.streak_days > 7 ? "bg-success-50" : usageStats.streak_days > 0 ? "bg-warning-50" : "bg-background-50"}
            />
          </HStack>
        </VStack>
      </VStack>
