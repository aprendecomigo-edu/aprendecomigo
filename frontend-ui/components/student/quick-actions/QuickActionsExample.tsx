          ...
          <Alert action="warning" variant="outline">
            ...
            <VStack space="sm" className="flex-1">
              ...
              <AlertText className="text-sm">
                You have less than 2 hours remaining. Consider purchasing more hours to continue your tutoring sessions.
              </AlertText>
          ...
          <Card className="p-4 bg-error-50 border-error-200">
            <VStack space="sm">
              <HStack className="items-center">
                ...
                <Text className="font-medium text-error-800">
        ...
        {isNearExpiry && nextExpiringPackage && (
          <Alert action="info" variant="outline">
            ...
            <VStack space="sm" className="flex-1">
              ...
              <AlertText className="text-sm">
                Your {nextExpiringPackage.plan_name} package expires in {nextExpiringPackage.days_until_expiry} days.
              </AlertText>
              ...
              {defaultPaymentMethod && (
                <HStack space="xs" className="items-center justify-center">
                  <Text className="text-xs text-typography-600">
                    Using {defaultPaymentMethod.card.brand.toUpperCase()} ••••{defaultPaymentMethod.card.last4}
                  </Text>
                </HStack>
              )}
            </VStack>
