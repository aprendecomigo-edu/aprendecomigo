...
import type { RenewalResponse, QuickTopUpResponse, StudentBalanceResponse } from '@/types/purchase';
          ...
          render: ({ id }) => (
            <Card className="mx-3 p-4 bg-success-500">
              <HStack space="sm" className="items-center">
                ...
                <Text className="text-white font-medium">Balance updated successfully!</Text>
              </HStack>
            </Card>
          ),
        });
  ...
  return (
    <VStack space="lg" className="p-6">
      ...
      <VStack space="md" className="items-center">
        <Card
          className={`p-4 ${responseData.bgColor} border ${responseData.borderColor} items-center`}
        >
        ...
        <VStack space="xs" className="items-center">
          ...
          {responseData.message && (
            <Text className="text-center text-typography-600">{responseData.message}</Text>
          )}
        </VStack>
      </VStack>
        ...
        <Card className="p-4 border border-outline-200">
          <VStack space="md">
            <HStack className="items-center justify-between">
              <Text className="font-semibold text-typography-900">Transaction Details</Text>
      ...
      <Card
        className={`p-4 ${
          hasRefreshedOnce ? 'bg-success-50 border-success-200' : 'bg-info-50 border-info-200'
        }`}
      >
        <HStack space="sm" className="items-center justify-between">
          <VStack space="xs" className="flex-1">
            <Text
              className={`font-medium ${hasRefreshedOnce ? 'text-success-800' : 'text-info-800'}`}
            >
      ...
      {balance && hasRefreshedOnce && (
        <Card className="p-4 bg-primary-50 border-primary-200">
          <VStack space="sm">
            <Text className="font-medium text-primary-800">Your Current Balance</Text>
            <HStack className="items-center justify-between">
      ...
      <VStack space="sm">
        {onDone && (
          <Button action="primary" variant="solid" size="lg" onPress={onDone}>
      ...
      <Card className="p-3 bg-info-50 border-info-200">
        <Text className="text-xs text-center text-info-700">
          A receipt has been sent to your email address. You can also view all your transactions in
