...
const mockFetchChannels = channelApi.fetchChannels as jest.MockedFunction<typeof channelApi.fetchChannels>;
  ...
  const mockChannels = [
    {
      ...
      is_direct: false,
      participants: [
        { id: 1, username: 'teacher1', email: 'teacher1@example.com', first_name: 'John', last_name: 'Doe' },
        { id: 2, username: 'student1', email: 'student1@example.com', first_name: 'Jane', last_name: 'Smith' },
      ],
      online: [
        { id: 1, username: 'teacher1', email: 'teacher1@example.com', first_name: 'John', last_name: 'Doe' },
      ],
      ...
      last_message: {
        id: 1,
        channel: 1,
        sender: { id: 1, username: 'teacher1', email: 'teacher1@example.com', first_name: 'John', last_name: 'Doe' },
    ...
    },
    {
      ...
      participants: [
        { id: 1, username: 'teacher1', email: 'teacher1@example.com', first_name: 'John', last_name: 'Doe' },
        { id: 3, username: 'student2', email: 'student2@example.com', first_name: 'Bob', last_name: 'Wilson' },
      ],
      online: [],
      ...
      last_message: {
        id: 2,
        channel: 2,
        sender: { id: 3, username: 'student2', email: 'student2@example.com', first_name: 'Bob', last_name: 'Wilson' },
  ...
  describe('Component Rendering', () => {
    ...
    it('should render empty state when no channels exist', async () => {
      ...
      await waitFor(() => {
        ...
        expect(getByText('As conversas aparecerão aqui quando você tiver professores e alunos cadastrados na escola.')).toBeTruthy();
      });
    });
