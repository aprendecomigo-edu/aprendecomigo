...
describe('Authentication Flow Integration Tests', () => {
  ...
  describe('Complete Sign In Flow', () => {
    it('should complete full sign in to dashboard flow', async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockRouter._mocks.push).toHaveBeenCalledWith('/auth/verify-code?email=existing%40example.com');
      ...
      const { getByPlaceholderText: getCodeInput, getByText: getVerifyButton } = renderWithProviders(<VerifyCode />);
      ...
      await waitFor(() => {
        ...
        expect(mockSetUser).toHaveBeenCalledWith({ id: 1, email: 'existing@example.com', name: 'Existing User' });
  ...
  describe('Complete Sign Up Flow', () => {
    it('should complete full tutor registration flow', async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockSetUser).toHaveBeenCalledWith({ id: 3, email: 'tutor@example.com', name: 'New Tutor', userType: 'tutor' });
        expect(mockRouter._mocks.push).toHaveBeenCalledWith('/onboarding/welcome');
      });
    });
    ...
    it('should complete full school registration flow', async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockSetUser).toHaveBeenCalledWith({ id: 4, email: 'admin@school.com', name: 'School Admin', userType: 'school' });
        expect(mockRouter._mocks.push).toHaveBeenCalledWith('/onboarding/welcome');
      });
    });
  });
  ...
  describe('Cross-Component State Management', () => {
    it('should maintain email context between SignIn and VerifyCode', async () => {
      ...
      await waitFor(() => {
        expect(mockRouter._mocks.push).toHaveBeenCalledWith('/auth/verify-code?email=context%40example.com');
      });
