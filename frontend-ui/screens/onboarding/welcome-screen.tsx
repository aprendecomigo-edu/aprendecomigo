import { CheckCircle, ArrowRight, SkipForward, Building2, Users, GraduationCap } from 'lucide-react-native';
    ...
    const createInitialTasks = async () => {
      ...
      try {
        ...
        await createOnboardingTask({
          ...
          description: 'Add school information, logo, and contact details to personalize your account',
          priority: 'high',
      ...
      <Box className={`${isMobile ? 'px-4 pt-12' : 'px-8 pt-16'} pb-8`}>
        <Center>
          <VStack space="lg" className="items-center max-w-2xl">
            ...
            >
              Thank you for joining our educational platform! You're now ready to transform 
              how your school manages tutoring sessions, teacher coordination, and student success.
            </Text>
          </VStack>
        </Center>
      </Box>
        ...
        <AlertDialogContent className="max-w-md">
          ...
          <AlertDialogBody>
            <Text className="text-gray-600">
              ...
              This will help you set up your school and get the most out of the platform.
            </Text>
