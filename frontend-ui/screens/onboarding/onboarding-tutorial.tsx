...
const createMobileOnboardingTutorialConfig = (): TutorialConfig => ({
...
export const OnboardingTutorial: React.FC<OnboardingTutorialProps> = ({
  ...
  }, [autoStart, state.isActive, progress, startTutorial, tutorialConfig]);

  // Handle tutorial completion
  useEffect(() => {
    if (!state.isActive && state.config?.id === tutorialConfig.id && state.currentStep > 0) {
