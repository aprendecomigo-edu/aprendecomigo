...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onGetStarted, onSkip }) => {
  ...
  return (
    <Box className="flex-1 bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      {/* Platform Capabilities Section - Mobile stacked layout */}
      <Box className="px-4 pb-8">
        <VStack space="md">
          <Heading size="lg" className="text-center text-gray-800 mb-4">
              ...
              <Card key={index} className="bg-white border-0 shadow-sm">
                <HStack space="md" className="items-center p-4">
                  <Box className="bg-blue-100 rounded-lg p-3">
                    <Icon as={capability.icon} size={20} className="text-blue-600" />
                  </Box>
      ...
      <Box className="px-4 pb-8 mt-auto">
