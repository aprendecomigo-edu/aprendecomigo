...
class BalanceMonitoringService:
    ...
    @classmethod
    def check_low_balance_students(cls, threshold: Decimal | None = None) -> list[dict[str, Any]]:
        """
    ...
    @classmethod
    def has_recent_notification(cls, student_id: int, notification_type: str, hours_threshold: int = 24) -> bool:
        """
    ...
    @classmethod
    def create_low_balance_notification(cls, student_id: int, balance_hours: Decimal, threshold: Decimal) -> Any | None:
        """
    ...
    @classmethod
    def create_package_expiring_notification(cls, student: Any, transaction: Any, days_until_expiry: int) -> Any | None:
        """
        ...
        try:
            ...
            expiry_date = (
                ...
                else timezone.now() + timedelta(days=days_until_expiry)
            )
    ...
    @classmethod
    def create_balance_depleted_notification(cls, student_id: int) -> Any | None:
        """
    ...
    def send_package_expiring_email(
        cls, student: CustomUser, transaction: Any, days_until_expiry: int
    ) -> dict[str, Any]:
        """
    ...
    def process_low_balance_alerts(cls) -> dict[str, Any]:
        ...
        try:
            ...
            for student_data in low_balance_students:
                try:
                    ...
                    if not cls.has_recent_notification(student_id, NotificationType.LOW_BALANCE):
                        notification = cls.create_low_balance_notification(student_id, balance_hours, threshold)
                        if notification:
                    ...
                    errors.append(f"Error processing student {student_data.get('student_id', 'unknown')}: {e!s}")
            ...
            return {"low_balance_alerts": 0, "emails_sent": 0, "errors": [str(e)], "total_students_processed": 0}
    ...
    def process_package_expiring_alerts(cls) -> dict[str, Any]:
        ...
        try:
            ...
            return {"package_expiring_alerts": 0, "emails_sent": 0, "errors": [str(e)]}
