...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Human-readable name for the sequence",
                        max_length=200,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Description of what this sequence does",
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Event that triggers this sequence",
                        max_length=50,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=5,
                        help_text="Maximum number of emails to send in this sequence",
                        verbose_name="maximum emails",
                    ),
                ),
                ...
                (
                    "school",
                    models.ForeignKey(
                        help_text="School this sequence belongs to",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Purchase transaction related to this notification (for package expiration)",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("package_expiring_alert", "Package Expiring Alert"),
                        ],
                ...
                (
                    "subject_template",
                    models.CharField(
                        help_text="Email subject with template variables like {{teacher_name}}",
                        max_length=300,
                ...
                (
                    "text_content",
                    models.TextField(
                        help_text="Plain text email content with template variables",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Apply school colors and logo to template",
                        verbose_name="use school branding",
                    ),
                ),
                (
                    "custom_css",
                    models.TextField(
                        blank=True,
                        help_text="Additional CSS for template customization",
                        null=True,
                ...
                (
                    "school",
                    models.ForeignKey(
                        help_text="School this template belongs to",
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=24,
                        help_text="Hours to wait before sending this email",
                        verbose_name="delay hours",
                    ),
                ),
                (
                    "send_condition",
                    models.CharField(
                        choices=[
                            ("always", "Always Send"),
                            ("if_no_response", "If No Response"),
                            ("if_not_accepted", "If Not Accepted"),
                            ("if_profile_incomplete", "If Profile Incomplete"),
                        ],
                        default="always",
                        help_text="Condition that must be met to send this email",
                        max_length=50,
                        verbose_name="send condition",
                    ),
                ),
                (
                    "is_active",
                    models.BooleanField(
                        default=True,
                        help_text="Whether this step is active",
                        verbose_name="is active",
                    ),
                ),
                (
                    "sequence",
                    models.ForeignKey(
                        help_text="Email sequence this step belongs to",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="steps",
                        to="messaging.emailsequence",
                    ),
                ),
                (
                    "template",
                    models.ForeignKey(
                        help_text="Email template to use for this step",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="sequence_steps",
                        to="messaging.schoolemailtemplate",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "school",
                    models.ForeignKey(
                        help_text="School that sent the email",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Related teacher invitation (if applicable)",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Email sequence this belongs to (if automated)",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="sent_emails",
                        to="messaging.emailsequence",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Sequence step this email represents",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="sent_emails",
                        to="messaging.emailsequencestep",
                    ),
                ),
                (
                    "template",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["school", "trigger_event", "is_active"],
                name="messaging_e_school__689758_idx",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="notification",
            index=models.Index(
                fields=["user", "created_at"], name="messaging_n_user_id_ccde73_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notification",
            index=models.Index(
                fields=["notification_type"], name="messaging_n_notific_98cedd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notification",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["school", "template_type", "is_active"],
                name="messaging_s_school__972290_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="schoolemailtemplate",
            index=models.Index(
                ...
                name="messaging_s_templat_70f354_idx",
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["sequence", "step_number", "is_active"],
                name="messaging_e_sequenc_05f657_idx",
            ),
        ),
        migrations.AddConstraint(
            model_name="emailsequencestep",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["school", "delivery_status", "-queued_at"],
                name="messaging_e_school__3ac19b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="emailcommunication",
            index=models.Index(
                fields=["recipient_email", "template_type", "-queued_at"],
                name="messaging_e_recipie_43c483_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="emailcommunication",
            index=models.Index(
                fields=["sequence", "delivery_status", "-queued_at"],
                name="messaging_e_sequenc_f393cf_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="emailcommunication",
            index=models.Index(
                fields=["teacher_invitation", "-queued_at"],
                name="messaging_e_teacher_0c3bb8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="emailcommunication",
            index=models.Index(
                fields=["delivery_status", "retry_count", "-queued_at"],
                name="messaging_e_deliver_8cc75b_idx",
            ),
        ),
    ]
