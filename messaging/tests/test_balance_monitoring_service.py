...
class BalanceMonitoringServiceTest(MessagingTestBase):
    ...
    def setUp(self):
        ...
        self.balance = self.create_student_balance(
            student=self.student, hours_purchased=10.0, hours_consumed=0.0, balance_amount=100.0
        )
    ...
    def test_custom_balance_threshold_allows_school_specific_policies(self):
        ...
        low_balance_custom = BalanceMonitoringService.check_low_balance_students(threshold=Decimal("3.0"))
    ...
    def test_package_expiration_detection_flags_packages_expiring_within_warning_period(self):
        ...
        expiring_transaction = self.create_purchase_transaction(expires_at_days=5)
    ...
    def test_notification_deduplication_prevents_spam(self):
        ...
        has_recent = BalanceMonitoringService.has_recent_notification(self.student.id, NotificationType.LOW_BALANCE)
    ...
    def test_email_alert_integration(self, mock_send_email):
        ...
        result = BalanceMonitoringService.send_low_balance_email(self.student, Decimal("1.5"))
    ...
    def test_comprehensive_monitoring_processes_multiple_alert_types(self):
        ...
        low_balance_student = self.create_student_user(email="lowbalance@test.com", name="Low Balance Student")
