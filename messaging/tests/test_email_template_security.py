...
from messaging.models import EmailTemplateType, SchoolEmailTemplate
from messaging.services.email_template_service import EmailTemplateRenderingService
from messaging.services.secure_template_engine import HTMLSanitizer, SecureTemplateEngine, TemplateVariableValidator
...
class SecureTemplateEngineTest(TestCase, SecurityTestMixin):
    ...
    def setUp(self):
        ...
        self.safe_context = {"name": "John Doe", "school_name": "Test School"}
    ...
    def test_safe_template_rendering_produces_expected_output(self):
        ...
        result = SecureTemplateEngine.render_template(self.safe_template, self.safe_context)
...
class TemplateVariableValidatorTest(TestCase, SecurityTestMixin):
    ...
    def test_oversized_string_rejection(self):
        ...
        dangerous_context = {"large_value": large_string}
...
class EmailTemplateAPISecurityTest(APITestCase, SecurityTestMixin):
    ...
    def setUp(self):
        ...
        self.school = School.objects.create(name="Test School", description="A test school for security testing")
        ...
        SchoolMembership.objects.create(user=self.user, school=self.school, role=SchoolRole.SCHOOL_OWNER)
    ...
    def _create_other_school(self):
        ...
        other_school = School.objects.create(name="Other School", description="Another test school")
        other_user = User.objects.create_user(email="other@example.com", password="testpass123")
        from accounts.models import SchoolMembership

        SchoolMembership.objects.create(user=other_user, school=other_school, role=SchoolRole.SCHOOL_OWNER)
...
class EmailTemplateRenderingSecurityTest(MessagingTestBase, SecurityTestMixin):
    ...
    def test_safe_template_rendering_includes_context(self):
        ...
        subject, html_content, text_content = EmailTemplateRenderingService.render_template(self.template, context)
    ...
    def test_xss_prevention_in_template_variables(self):
        ...
        context = {"name": '<script>alert("xss")</script>', "message": "<img src=x onerror=alert(1)>"}
    ...
    def test_malicious_context_rejection(self):
        ...
        with self.assertRaises(ValueError):
            EmailTemplateRenderingService.render_template(self.template, malicious_context)
