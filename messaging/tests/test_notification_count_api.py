...
class NotificationCountAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        # Create a school
        self.school = School.objects.create(name="Test School", description="A test school for notifications")

        # Create another school for isolation testing
        self.other_school = School.objects.create(
            name="Other School", description="Should not affect notification counts"
        )
        ...
        self.teacher_user = CustomUser.objects.create_user(
            email="teacher@testschool.com", name="John Teacher", first_login_completed=True
        )
        ...
        self.new_user1 = CustomUser.objects.create_user(
            email="new1@testschool.com", name="New User 1", first_login_completed=False
        )

        SchoolMembership.objects.create(user=self.new_user1, school=self.school, role=SchoolRole.TEACHER)

        self.new_user2 = CustomUser.objects.create_user(
            email="new2@testschool.com", name="New User 2", first_login_completed=False
        )

        SchoolMembership.objects.create(user=self.new_user2, school=self.school, role=SchoolRole.STUDENT)

        # Create user in other school (should not affect counts)
        self.other_user = CustomUser.objects.create_user(
            email="other@otherschool.com", name="Other User", first_login_completed=False
        )

        SchoolMembership.objects.create(user=self.other_user, school=self.other_school, role=SchoolRole.TEACHER)
